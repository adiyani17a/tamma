<div id="wait-tab" class="tab-pane fade in">
    <div class="row">
   
    <div class="col-md-3 col-sm-3 col-xs-12" align="left">
      <button class="btn btn-box-tool btn-sm btn-flat" type="button" id="btn_refresh_wait" onclick="refreshTabelWait()">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">                          
      <div class="table-responsive">
        <table class="table tabelan table-hover table-bordered" width="100%" cellspacing="0" id="tbl-wait">
          <thead>
            <tr>
