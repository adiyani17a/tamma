    <div class="col-md-12 tamma-bg" style="margin-top: 5px;margin-bottom: 5px;margin-bottom: 20px; padding-bottom:20px;padding-top:20px;" >
         <div class="col-md-6">
           <label class="control-label tebal" for="">Masukan Kode / Namaaaa</label>
        ...
        <tbody>
          ...
          <tr>
            <td>
              ...
              <input type="hidden" id="saya" name="kode_item[]" class="kode_item kode" value="{{ $x->i_id }}">
              <input type="hidden" name="nama_item[]" class="nama_item" value="{{ $x->i_name }}">
            </td>
            <td>
              <input size="30" style="text-align:right" type="number"  name="sd_qty[]" class="sd_qty form-control qty-{{$x->i_id }}" value="{{$x->sd_qty }}" onkeyup="UpdateHarga('{{ $x->i_id }}'); qtyInput('', '{{ $x->i_id }}')" onchange="qtyInput('', '{{ $x->i_id }}')">
            </td>
            <td>
