                ...
                <div class="col-md-12 col-sm-12 col-xs-12 " style="margin-top:15px;">
                  <form method="POST" action="{{ url('master/datapegawai/update-pegawai')}}/{{$data->c_id}}">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      ...
                      <div class="col-md-3 col-sm-8 col-xs-12">
                        <div class="form-group">
                          <input class="form-control input-sm" type="text" name="c_nik" id="nik" value="{{ $data->c_nik }}">
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-4 col-xs-12">
                      ...
                      <div class="col-md-3 col-sm-8 col-xs-12">
                        <div class="form-group">
                          <input type="text" name="c_name" id="c_name" class="form-control input-sm" value="{{ $data->c_name }}">
                        </div>
                      </div>
                      <div class="col-md-3 col-sm-4 col-xs-12">
                      ...
                      <div class="col-md-3 col-sm-8 col-xs-12">
                        <div class="form-group">
                          <input type="text" id="tgl_masuk" name="c_year" data-date-format="dd-mm-yyyy" class="datepicker form-control input-sm"
                            placeholder="dd-mm-yyyy" value="{{ $data->c_year }}">
                        </div>
                      </div>                    
                    </div>
                    <div align="right">
