...
Route::get('penjualan/transfer/grosir/simpan-transfer-grosir', 'transferItemController@simpanTransferGrosir');

Route::get('penjualan/transfer/grosir/data-transfer-grosir', 'transferItemController@dataTransferGrosir');
